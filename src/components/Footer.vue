  ...
  <footer class="bg-gray-900 text-gray-300">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
        <!-- Logo & About -->
        <div>
          <img src="../assets/logo.svg" alt="Logo" class="h-8 w-auto mb-4">
          <p class="text-gray-400 mb-4">
            Empowering students and educators with advanced computer-based testing solutions.
          </p>
          <!-- Social Media Icons -->
        ...
        <div>
          ...
          <ul class="space-y-2">
            ...
            <li><a href="#" class="text-gray-400 hover:text-white transition-colors">Study Materials</a></li>
          ...
          <form @submit.prevent="handleSubscribe" class="space-y-3">
            <div>
              <input
                ...
                class="w-full px-4 py-2 bg-gray-800 text-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
              >
            </div>
            <button
              type="submit"
    ...
    <div class="bg-gray-800 py-4">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <p class="text-center text-gray-400">
          © {{ new Date().getFullYear() }} Romaysoft. All rights reserved.
        </p>
      </div>
    </div>
  </footer>
